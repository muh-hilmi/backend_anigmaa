...
('m0000001-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001',
...
('m0000002-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001',
...
('m0000003-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001',
...
('m0000001-0000-0000-0000-000000000001', 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97', 0),
('m0000001-0000-0000-0000-000000000001', 'https://images.unsplash.com/photo-1498050108023-c5249f4df085', 1),
('m0000002-0000-0000-0000-000000000002', 'https://images.unsplash.com/photo-1556761175-4b46a572b786', 0),
('m0000003-0000-0000-0000-000000000003', 'https://images.unsplash.com/photo-1559136555-9303baea8ebd', 0)
ON CONFLICT DO NOTHING;

-- Event attendees
INSERT INTO event_attendees (event_id, user_id, status) VALUES
('m0000001-0000-0000-0000-000000000001', '99999999-9999-9999-9999-999999999999', 'confirmed'),
('m0000001-0000-0000-0000-000000000001', '50505050-5050-5050-5050-505050505050', 'confirmed'),
('m0000001-0000-0000-0000-000000000001', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'confirmed'),
('m0000001-0000-0000-0000-000000000001', '80808080-8080-8080-8080-808080808080', 'confirmed'),
('m0000001-0000-0000-0000-000000000001', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'confirmed'),
('m0000002-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111', 'confirmed'),
('m0000002-0000-0000-0000-000000000002', '99999999-9999-9999-9999-999999999999', 'confirmed'),
('m0000002-0000-0000-0000-000000000002', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'confirmed'),
('m0000003-0000-0000-0000-000000000003', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'confirmed'),
('m0000003-0000-0000-0000-000000000003', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'confirmed')
ON CONFLICT (event_id, user_id) DO NOTHING;

-- Event Q&A
INSERT INTO event_qna (event_id, user_id, question, answer, answered_by, answered_at, is_answered) VALUES
('m0000001-0000-0000-0000-000000000001', '99999999-9999-9999-9999-999999999999',
...
('m0000001-0000-0000-0000-000000000001', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb',
...
'00000000-0000-0000-0000-000000000001', NOW(), true),
('m0000002-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111',
...
'text_with_event', 'm0000001-0000-0000-0000-000000000001', 'public', NOW() - INTERVAL '3 days'),
...
'text_with_event', 'm0000002-0000-0000-0000-000000000002', 'public', NOW() - INTERVAL '2 days'),

('m0000004-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001',
...
('m0000005-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000001',
...
('m0000006-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000001',
...
'text_with_event', 'm0000003-0000-0000-0000-000000000003', 'public', NOW() - INTERVAL '4 days'),

('m0000007-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000001',
...
('m0000008-0000-0000-0000-000000000008', '00000000-0000-0000-0000-000000000001',
...
('m0000005-0000-0000-0000-000000000005', 'https://images.unsplash.com/photo-1587825140708-dfaf72ae4b04', 0),
('m0000005-0000-0000-0000-000000000005', 'https://images.unsplash.com/photo-1498050108023-c5249f4df085', 1)
ON CONFLICT DO NOTHING;
...
('11111111-1111-1111-1111-111111111111', 'post', 'm0000001-0000-0000-0000-000000000001'),
('99999999-9999-9999-9999-999999999999', 'post', 'm0000001-0000-0000-0000-000000000001'),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'post', 'm0000001-0000-0000-0000-000000000001'),
('50505050-5050-5050-5050-505050505050', 'post', 'm0000001-0000-0000-0000-000000000001'),
('dddddddd-dddd-dddd-dddd-dddddddddddd', 'post', 'm0000001-0000-0000-0000-000000000001'),

('99999999-9999-9999-9999-999999999999', 'post', 'm0000002-0000-0000-0000-000000000002'),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'post', 'm0000002-0000-0000-0000-000000000002'),
('80808080-8080-8080-8080-808080808080', 'post', 'm0000002-0000-0000-0000-000000000002'),
('50505050-5050-5050-5050-505050505050', 'post', 'm0000002-0000-0000-0000-000000000002'),

('11111111-1111-1111-1111-111111111111', 'post', 'm0000004-0000-0000-0000-000000000004'),
('99999999-9999-9999-9999-999999999999', 'post', 'm0000004-0000-0000-0000-000000000004'),
('50505050-5050-5050-5050-505050505050', 'post', 'm0000004-0000-0000-0000-000000000004'),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'post', 'm0000004-0000-0000-0000-000000000004'),
('cccccccc-cccc-cccc-cccc-cccccccccccc', 'post', 'm0000004-0000-0000-0000-000000000004'),
('80808080-8080-8080-8080-808080808080', 'post', 'm0000004-0000-0000-0000-000000000004'),

('99999999-9999-9999-9999-999999999999', 'post', 'm0000007-0000-0000-0000-000000000007'),
('50505050-5050-5050-5050-505050505050', 'post', 'm0000007-0000-0000-0000-000000000007'),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'post', 'm0000007-0000-0000-0000-000000000007'),
('dddddddd-dddd-dddd-dddd-dddddddddddd', 'post', 'm0000007-0000-0000-0000-000000000007')
...
('m0000001-0000-0000-0000-000000000001', 'm0000001-0000-0000-0000-000000000001', '99999999-9999-9999-9999-999999999999', NULL,
'This looks awesome! Already registered 🚀', NOW() - INTERVAL '2 days'),
('m0000002-0000-0000-0000-000000000002', 'm0000001-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'm0000001-0000-0000-0000-000000000001',
'See you there! Bring your questions 😊', NOW() - INTERVAL '2 days'),
('m0000003-0000-0000-0000-000000000003', 'm0000001-0000-0000-0000-000000000001', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', NULL,
'Will you cover GraphQL too or just REST?', NOW() - INTERVAL '2 days'),
('m0000004-0000-0000-0000-000000000004', 'm0000001-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'm0000003-0000-0000-0000-000000000003',
'Good question! We''ll focus on REST but I can do a bonus GraphQL section if there''s time', NOW() - INTERVAL '1 day'),

('m0000005-0000-0000-0000-000000000005', 'm0000002-0000-0000-0000-000000000002', '99999999-9999-9999-9999-999999999999', NULL,
'The best feeling! 🎉 What was the feature?', NOW() - INTERVAL '5 days'),
('m0000006-0000-0000-0000-000000000006', 'm0000002-0000-0000-0000-000000000002', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', NULL,
'3 rounds? That''s rookie numbers 😂 jk congrats!', NOW() - INTERVAL '4 days'),

('m0000007-0000-0000-0000-000000000007', 'm0000004-0000-0000-0000-000000000004', '50505050-5050-5050-5050-505050505050', NULL,
'100% agree! Depth > breadth. I spent 2 years mastering React and now picking up Vue was super easy.', NOW() - INTERVAL '6 days'),
('m0000008-0000-0000-0000-000000000008', 'm0000004-0000-0000-0000-000000000004', 'cccccccc-cccc-cccc-cccc-cccccccccccc', NULL,
'Hot take indeed! But I think it depends on your role. Full-stack devs need broader knowledge.', NOW() - INTERVAL '5 days'),
('m0000009-0000-0000-0000-000000000009', 'm0000004-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001', 'm0000008-0000-0000-0000-000000000008',
'Fair point! I think deep knowledge in one, good understanding of others is the sweet spot.', NOW() - INTERVAL '5 days'),

('m0000010-0000-0000-0000-000000000010', 'm0000007-0000-0000-0000-000000000007', '99999999-9999-9999-9999-999999999999', NULL,
'Indexes are magic! 🪄 Can you share the query optimization?', NOW() - INTERVAL '7 hours'),
('m0000011-0000-0000-0000-000000000011', 'm0000007-0000-0000-0000-000000000007', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', NULL,
'That''s insane improvement! EXPLAIN ANALYZE is your best friend', NOW() - INTERVAL '6 hours')
ON CONFLICT (id) DO NOTHING;

-- Likes on comments
INSERT INTO likes (user_id, likeable_type, likeable_id) VALUES
('00000000-0000-0000-0000-000000000001', 'comment', 'm0000001-0000-0000-0000-000000000001'),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'comment', 'm0000001-0000-0000-0000-000000000001'),
('99999999-9999-9999-9999-999999999999', 'comment', 'm0000007-0000-0000-0000-000000000007'),
('11111111-1111-1111-1111-111111111111', 'comment', 'm0000007-0000-0000-0000-000000000007'),
('50505050-5050-5050-5050-505050505050', 'comment', 'm0000007-0000-0000-0000-000000000007')
ON CONFLICT (user_id, likeable_type, likeable_id) DO NOTHING;
