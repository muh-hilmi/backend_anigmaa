...
('p0000001-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'Excited to host my first coffee cupping session! 🎉 Join us this weekend untuk explore Ethiopian coffee beans yang amazing. Limited seats, daftar sekarang! ☕', 'text_with_event', 'e0000001-0000-0000-0000-000000000001', 'public', NOW() - INTERVAL '2 days'),
('p0000002-0000-0000-0000-000000000002', '22222222-2222-2222-2222-222222222222', 'Calling all foodies! 🍜 Street food tour besok sore around Jakarta. We''ll explore 5 legendary spots. Siapa yang mau ikutan? Tag your foodie friends!', 'text_with_event', 'e0000004-0000-0000-0000-000000000004', 'public', NOW() - INTERVAL '3 days'),
('p0000003-0000-0000-0000-000000000003', '33333333-3333-3333-3333-333333333333', 'MOBILE LEGENDS TOURNAMENT ALERT! 🎮🏆 Prize pool 5 juta! Registration closing soon. Ajak team kalian sekarang!', 'text_with_event', 'e0000008-0000-0000-0000-000000000008', 'public', NOW() - INTERVAL '4 days'),

-- Regular text posts
('p0000004-0000-0000-0000-000000000004', '44444444-4444-4444-4444-444444444444', 'Just finished a new watercolor painting! The sunset colors turned out better than expected 🎨✨ Sometimes the best art happens when you just let go and trust the process.', 'text', NULL, 'public', NOW() - INTERVAL '1 day'),
('p0000005-0000-0000-0000-000000000005', '55555555-5555-5555-5555-555555555555', 'Completed my first 10K run today! 🏃‍♂️💪 Time: 58:32. Not bad for a beginner. The key is consistency, not speed. Keep moving forward!', 'text', NULL, 'public', NOW() - INTERVAL '5 hours'),
('p0000006-0000-0000-0000-000000000006', '66666666-6666-6666-6666-666666666666', 'Currently reading "Educated" by Tara Westover and wow... speechless. Her journey is incredibly inspiring. Anyone else read this? Let''s discuss! 📚', 'text', NULL, 'public', NOW() - INTERVAL '12 hours'),
('p0000007-0000-0000-0000-000000000007', '77777777-7777-7777-7777-777777777777', 'Working on a new track 🎵 Been in the studio for 6 hours straight and I think we''re onto something special. Can''t wait to share it with you all!', 'text', NULL, 'public', NOW() - INTERVAL '8 hours'),
('p0000008-0000-0000-0000-000000000008', '99999999-9999-9999-9999-999999999999', 'Finally deployed my first full-stack app! 🚀 React + Node.js + PostgreSQL. So many bugs fixed, so many lessons learned. The feeling is unreal!', 'text', NULL, 'public', NOW() - INTERVAL '2 days'),
('p0000009-0000-0000-0000-000000000009', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Morning yoga session hits different when you do it at the park 🧘‍♀️ The fresh air and bird sounds are the best meditation soundtrack. Namaste 🙏', 'text', NULL, 'public', NOW() - INTERVAL '15 hours'),
('p0000010-0000-0000-0000-000000000010', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Trying a new coffee brewing method today: Japanese iced coffee ☕❄️ The flavor is SO much better than regular cold brew. Mind = blown!', 'text', NULL, 'public', NOW() - INTERVAL '6 hours'),

-- Posts with images
('p0000011-0000-0000-0000-000000000011', '88888888-8888-8888-8888-888888888888', 'Golden hour at Kota Tua was absolutely magical today 📸✨ Managed to capture some incredible shots. Swipe to see the full series!', 'text_with_images', NULL, 'public', NOW() - INTERVAL '1 day'),
('p0000012-0000-0000-0000-000000000012', '22222222-2222-2222-2222-222222222222', 'Made homemade pasta from scratch! 🍝 It was challenging but so worth it. The taste is incomparable to store-bought pasta. Here''s the process!', 'text_with_images', NULL, 'public', NOW() - INTERVAL '18 hours'),
('p0000013-0000-0000-0000-000000000013', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'Today''s outfit inspo ✨ Mixing vintage with contemporary pieces. Fashion is all about expressing yourself! What do you think?', 'text_with_images', NULL, 'public', NOW() - INTERVAL '10 hours'),
('p0000014-0000-0000-0000-000000000014', 'ffffffff-ffff-ffff-ffff-ffffffffffff', 'Behind the scenes of today''s cooking class 👨‍🍳 These students are amazing! We made authentic Italian risotto. Check out their creations!', 'text_with_images', NULL, 'public', NOW() - INTERVAL '7 hours'),
('p0000015-0000-0000-0000-000000000015', '44444444-4444-4444-4444-444444444444', 'My latest illustration project 🎨 Inspired by Indonesian folklore. Took me 12 hours to complete. Art is patience!', 'text_with_images', NULL, 'public', NOW() - INTERVAL '2 days'),
...
('p0000017-0000-0000-0000-000000000017', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'Startup life update: Just closed our seed round! 🎉💰 The journey from idea to funding was intense. Grateful for everyone who believed in our vision. This is just the beginning!', 'text', NULL, 'public', NOW() - INTERVAL '3 days'),
('p0000018-0000-0000-0000-000000000018', '10101010-1010-1010-1010-101010101010', 'Watching anime at 3AM hits different lol 😂 Just finished Attack on Titan final season and I have SO MANY FEELINGS. No spoilers please for those who haven''t watched!', 'text', NULL, 'public', NOW() - INTERVAL '4 hours'),
('p0000019-0000-0000-0000-000000000019', '20202020-2020-2020-2020-202020202020', 'Best cycling routes in Jakarta? Drop your recommendations! 🚴‍♂️ Planning to explore new areas this weekend. Preferably with good coffee shops along the way ☕', 'text', NULL, 'public', NOW() - INTERVAL '16 hours'),
('p0000020-0000-0000-0000-000000000020', '30303030-3030-3030-3030-303030303030', 'Dance practice was INTENSE today 💃 We''re preparing for a big performance next month. My legs are sore but my heart is happy. This is what passion feels like!', 'text', NULL, 'public', NOW() - INTERVAL '11 hours'),

-- More posts with events
('p0000021-0000-0000-0000-000000000021', '55555555-5555-5555-5555-555555555555', 'Sunday morning run club this weekend! 🏃‍♀️ All fitness levels welcome. Let''s start the week with endorphins and good vibes. See you at GBK!', 'text_with_event', 'e0000011-0000-0000-0000-000000000011', 'public', NOW() - INTERVAL '5 days'),
('p0000022-0000-0000-0000-000000000022', '77777777-7777-7777-7777-777777777777', 'Indie music night coming up! 🎸🎤 Featuring some of the best local bands in Jakarta. If you love good music and good vibes, you can''t miss this.', 'text_with_event', 'e0000015-0000-0000-0000-000000000015', 'public', NOW() - INTERVAL '6 days'),
('p0000023-0000-0000-0000-000000000023', '44444444-4444-4444-4444-444444444444', 'Watercolor painting workshop next week! 🎨 Perfect for beginners who want to learn this beautiful art form. All materials provided, just bring your creativity!', 'text_with_event', 'e0000023-0000-0000-0000-000000000023', 'public', NOW() - INTERVAL '7 days'),

-- More regular posts
('p0000024-0000-0000-0000-000000000024', '40404040-4040-4040-4040-404040404040', 'Just wrapped filming for a new documentary about Jakarta''s hidden gems 🎬 The stories we captured are incredible. Can''t wait to share it with everyone!', 'text', NULL, 'public', NOW() - INTERVAL '1 day'),
('p0000025-0000-0000-0000-000000000025', '50505050-5050-5050-5050-505050505050', 'Teaching high school students about climate change today. Their questions were so thoughtful and inspiring 🌍 The next generation gives me hope!', 'text', NULL, 'public', NOW() - INTERVAL '9 hours'),
('p0000026-0000-0000-0000-000000000026', '60606060-6060-6060-6060-606060606060', 'Basketball training session was fire today! 🏀🔥 Working on my three-point shot. Practice makes progress, not perfection.', 'text', NULL, 'public', NOW() - INTERVAL '14 hours'),
('p0000027-0000-0000-0000-000000000027', '70707070-7070-7070-7070-707070707070', 'Just posted a new vlog about Jakarta''s best coffee spots! ☕📹 Link in bio. Let me know which cafe I should review next!', 'text', NULL, 'public', NOW() - INTERVAL '22 hours'),
('p0000028-0000-0000-0000-000000000028', '80808080-8080-8080-8080-808080808080', 'Working on a new logo design for a client 🎨💻 The creative process is messy but magical. Here''s to late nights and coffee-fueled inspiration!', 'text', NULL, 'public', NOW() - INTERVAL '3 hours'),
('p0000029-0000-0000-0000-000000000029', '90909090-9090-9090-9090-909090909090', 'Meal prep Sunday! 🥗 Prepared healthy lunches for the whole week. Nutrition is self-care. Your body will thank you!', 'text', NULL, 'public', NOW() - INTERVAL '1 day'),
('p0000030-0000-0000-0000-000000000030', 'a0a0a0a0-a0a0-a0a0-a0a0-a0a0a0a0a0a0', 'New song coming this Friday! 🎵🎸 Been working on this for months. The wait is almost over. Pre-save link coming soon!', 'text', NULL, 'public', NOW() - INTERVAL '2 days'),

-- More posts with images
('p0000031-0000-0000-0000-000000000031', '11111111-1111-1111-1111-111111111111', 'Coffee art game strong today ☕✨ Managed to pour a perfect rosetta! Practice really does make better. Here''s the progression shots!', 'text_with_images', NULL, 'public', NOW() - INTERVAL '13 hours'),
('p0000032-0000-0000-0000-000000000032', '88888888-8888-8888-8888-888888888888', 'Sunset photography from rooftop Jakarta 🌅 The city looks beautiful from up here. Sometimes we need to change our perspective to see beauty.', 'text_with_images', NULL, 'public', NOW() - INTERVAL '19 hours'),
('p0000033-0000-0000-0000-000000000033', '33333333-3333-3333-3333-333333333333', 'New gaming setup complete! 🎮⚡ RGB everything lol. Ready for that tournament next week. Let''s goooo!', 'text_with_images', NULL, 'public', NOW() - INTERVAL '2 days'),

-- More text posts
('p0000034-0000-0000-0000-000000000034', '99999999-9999-9999-9999-999999999999', 'Debugging is like being a detective in a crime movie where you are also the murderer 😅 Finally found that bug after 3 hours. The culprit? A missing semicolon. Classic.', 'text', NULL, 'public', NOW() - INTERVAL '17 hours'),
('p0000035-0000-0000-0000-000000000035', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Coffee tip of the day: Water temperature matters! 92-96°C is the sweet spot for most brewing methods ☕🌡️ Too hot = bitter, too cold = sour. Science!', 'text', NULL, 'public', NOW() - INTERVAL '21 hours'),
('p0000036-0000-0000-0000-000000000036', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'Social media algorithm changes again 📱 Time to adapt our strategy. The key is always authentic content and community engagement. Algorithms come and go, but real connections last.', 'text', NULL, 'public', NOW() - INTERVAL '1 day'),
('p0000037-0000-0000-0000-000000000037', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'Pitch deck tip: Tell a story, not just facts 📊 Investors invest in people and vision, not just numbers. Make them feel your passion!', 'text', NULL, 'public', NOW() - INTERVAL '4 days'),
('p0000038-0000-0000-0000-000000000038', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'Thrifting finds of the week! 🛍️ Found some vintage pieces that are absolute gems. Sustainable fashion is the future!', 'text', NULL, 'public', NOW() - INTERVAL '23 hours'),
('p0000039-0000-0000-0000-000000000039', 'ffffffff-ffff-ffff-ffff-ffffffffffff', 'Cooking is like chemistry but you can eat the results 👨‍🍳🧪 Today''s experiment: fusion Indonesian-Italian cuisine. Rendang risotto anyone?', 'text', NULL, 'public', NOW() - INTERVAL '15 hours'),
('p0000040-0000-0000-0000-000000000040', '10101010-1010-1010-1010-101010101010', 'Anime recommendation thread! Drop your top 3 anime below 👇 Always looking for new shows to watch. My current faves: AOT, Demon Slayer, JJK.', 'text', NULL, 'public', NOW() - INTERVAL '12 hours'),

-- More event posts
('p0000041-0000-0000-0000-000000000041', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'Startup founders! 🚀 Don''t miss our networking mixer. Connect with investors, get feedback on your pitch, and meet fellow entrepreneurs. Let''s build together!', 'text_with_event', 'e0000026-0000-0000-0000-000000000026', 'public', NOW() - INTERVAL '5 days'),
('p0000042-0000-0000-0000-000000000042', '50505050-5050-5050-5050-505050505050', 'Python study group this week! 🐍💻 Perfect for beginners. We''ll cover loops, functions, and data structures. Bring your laptop and questions!', 'text_with_event', 'e0000020-0000-0000-0000-000000000020', 'public', NOW() - INTERVAL '6 days'),
('p0000043-0000-0000-0000-000000000043', '88888888-8888-8888-8888-888888888888', 'Photography walk around Old Jakarta! 📸🏛️ Let''s capture the beauty of historical architecture. Beginner photographers welcome!', 'text_with_event', 'e0000030-0000-0000-0000-000000000030', 'public', NOW() - INTERVAL '7 days'),

-- Final posts
('p0000044-0000-0000-0000-000000000044', '11111111-1111-1111-1111-111111111111', 'Random thought: The best conversations happen over coffee ☕💬 There''s something about caffeine that makes us more creative and connected.', 'text', NULL, 'public', NOW() - INTERVAL '8 hours'),
('p0000045-0000-0000-0000-000000000045', '22222222-2222-2222-2222-222222222222', 'Food coma after that amazing nasi goreng 😴🍛 Sometimes the best comfort is in our traditional food. Nothing beats Indonesian cuisine!', 'text', NULL, 'public', NOW() - INTERVAL '5 hours'),
('p0000046-0000-0000-0000-000000000046', '33333333-3333-3333-3333-333333333333', 'Pro tip for gamers: Take breaks! 🎮⏸️ Your performance actually improves when you rest your eyes and stretch. Health > Rank.', 'text', NULL, 'public', NOW() - INTERVAL '11 hours'),
('p0000047-0000-0000-0000-000000000047', '55555555-5555-5555-5555-555555555555', 'Marathon training week 8 done! 🏃‍♂️✅ The journey from couch to marathon is real. Every step counts. Keep going!', 'text', NULL, 'public', NOW() - INTERVAL '7 hours'),
('p0000048-0000-0000-0000-000000000048', '77777777-7777-7777-7777-777777777777', 'Music is the universal language 🎵🌍 Doesn''t matter where you''re from, good music connects us all. What song are you listening to right now?', 'text', NULL, 'public', NOW() - INTERVAL '9 hours'),
('p0000049-0000-0000-0000-000000000049', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Yoga isn''t about touching your toes, it''s about what you learn on the way down 🧘‍♀️✨ Flexibility of mind > flexibility of body.', 'text', NULL, 'public', NOW() - INTERVAL '6 hours'),
('p0000050-0000-0000-0000-000000000050', '99999999-9999-9999-9999-999999999999', 'Just remembered why I love coding: The moment when your code finally works after hours of debugging 🎉💻 That dopamine hit is unmatched!', 'text', NULL, 'public', NOW() - INTERVAL '4 hours');
...
('p0000011-0000-0000-0000-000000000011', 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5', 0),
('p0000011-0000-0000-0000-000000000011', 'https://images.unsplash.com/photo-1581888227599-779811939961', 1),
('p0000011-0000-0000-0000-000000000011', 'https://images.unsplash.com/photo-1547981609-4b6bfe67ca0b', 2),

-- Post 12 images (pasta)
('p0000012-0000-0000-0000-000000000012', 'https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9', 0),
('p0000012-0000-0000-0000-000000000012', 'https://images.unsplash.com/photo-1612874742237-6526221588e3', 1),

-- Post 13 images (fashion)
('p0000013-0000-0000-0000-000000000013', 'https://images.unsplash.com/photo-1483985988355-763728e1935b', 0),

-- Post 14 images (cooking)
('p0000014-0000-0000-0000-000000000014', 'https://images.unsplash.com/photo-1556910103-1c02745aae4d', 0),
('p0000014-0000-0000-0000-000000000014', 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136', 1),

-- Post 15 images (art)
('p0000015-0000-0000-0000-000000000015', 'https://images.unsplash.com/photo-1513364776144-60967b0f800f', 0),
('p0000015-0000-0000-0000-000000000015', 'https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b', 1),

-- Post 31 images (coffee art)
('p0000031-0000-0000-0000-000000000031', 'https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd', 0),
('p0000031-0000-0000-0000-000000000031', 'https://images.unsplash.com/photo-1509042239860-f550ce710b93', 1),

-- Post 32 images (sunset)
('p0000032-0000-0000-0000-000000000032', 'https://images.unsplash.com/photo-1495954484750-af469f2f9be5', 0),
('p0000032-0000-0000-0000-000000000032', 'https://images.unsplash.com/photo-1519681393784-d120267933ba', 1),

-- Post 33 images (gaming setup)
('p0000033-0000-0000-0000-000000000033', 'https://images.unsplash.com/photo-1593305841991-05c297ba4575', 0);
...
-- Post 1 likes
('22222222-2222-2222-2222-222222222222', 'post', 'p0000001-0000-0000-0000-000000000001'),
('33333333-3333-3333-3333-333333333333', 'post', 'p0000001-0000-0000-0000-000000000001'),
('44444444-4444-4444-4444-444444444444', 'post', 'p0000001-0000-0000-0000-000000000001'),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'post', 'p0000001-0000-0000-0000-000000000001'),
('cccccccc-cccc-cccc-cccc-cccccccccccc', 'post', 'p0000001-0000-0000-0000-000000000001'),

-- Post 2 likes
('11111111-1111-1111-1111-111111111111', 'post', 'p0000002-0000-0000-0000-000000000002'),
('ffffffff-ffff-ffff-ffff-ffffffffffff', 'post', 'p0000002-0000-0000-0000-000000000002'),
('66666666-6666-6666-6666-666666666666', 'post', 'p0000002-0000-0000-0000-000000000002'),
('77777777-7777-7777-7777-777777777777', 'post', 'p0000002-0000-0000-0000-000000000002'),

-- Post 3 likes
('99999999-9999-9999-9999-999999999999', 'post', 'p0000003-0000-0000-0000-000000000003'),
('10101010-1010-1010-1010-101010101010', 'post', 'p0000003-0000-0000-0000-000000000003'),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'post', 'p0000003-0000-0000-0000-000000000003'),
('30303030-3030-3030-3030-303030303030', 'post', 'p0000003-0000-0000-0000-000000000003'),
('40404040-4040-4040-4040-404040404040', 'post', 'p0000003-0000-0000-0000-000000000003'),
('60606060-6060-6060-6060-606060606060', 'post', 'p0000003-0000-0000-0000-000000000003'),

-- Post 4 likes
('11111111-1111-1111-1111-111111111111', 'post', 'p0000004-0000-0000-0000-000000000004'),
('22222222-2222-2222-2222-222222222222', 'post', 'p0000004-0000-0000-0000-000000000004'),
('88888888-8888-8888-8888-888888888888', 'post', 'p0000004-0000-0000-0000-000000000004'),
('80808080-8080-8080-8080-808080808080', 'post', 'p0000004-0000-0000-0000-000000000004'),

-- Post 5 likes
('11111111-1111-1111-1111-111111111111', 'post', 'p0000005-0000-0000-0000-000000000005'),
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'post', 'p0000005-0000-0000-0000-000000000005'),
('20202020-2020-2020-2020-202020202020', 'post', 'p0000005-0000-0000-0000-000000000005'),
('90909090-9090-9090-9090-909090909090', 'post', 'p0000005-0000-0000-0000-000000000005'),
('60606060-6060-6060-6060-606060606060', 'post', 'p0000005-0000-0000-0000-000000000005'),

-- Post 6 likes
('22222222-2222-2222-2222-222222222222', 'post', 'p0000006-0000-0000-0000-000000000006'),
('44444444-4444-4444-4444-444444444444', 'post', 'p0000006-0000-0000-0000-000000000006'),
('50505050-5050-5050-5050-505050505050', 'post', 'p0000006-0000-0000-0000-000000000006'),

-- Post 8 likes (developer post)
('33333333-3333-3333-3333-333333333333', 'post', 'p0000008-0000-0000-0000-000000000008'),
('50505050-5050-5050-5050-505050505050', 'post', 'p0000008-0000-0000-0000-000000000008'),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'post', 'p0000008-0000-0000-0000-000000000008'),
('80808080-8080-8080-8080-808080808080', 'post', 'p0000008-0000-0000-0000-000000000008'),
('dddddddd-dddd-dddd-dddd-dddddddddddd', 'post', 'p0000008-0000-0000-0000-000000000008'),

-- Post 11 likes (photography)
('44444444-4444-4444-4444-444444444444', 'post', 'p0000011-0000-0000-0000-000000000011'),
('11111111-1111-1111-1111-111111111111', 'post', 'p0000011-0000-0000-0000-000000000011'),
('70707070-7070-7070-7070-707070707070', 'post', 'p0000011-0000-0000-0000-000000000011'),
('40404040-4040-4040-4040-404040404040', 'post', 'p0000011-0000-0000-0000-000000000011'),
('80808080-8080-8080-8080-808080808080', 'post', 'p0000011-0000-0000-0000-000000000011'),
('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'post', 'p0000011-0000-0000-0000-000000000011'),

-- Post 15 likes (art)
('88888888-8888-8888-8888-888888888888', 'post', 'p0000015-0000-0000-0000-000000000015'),
('80808080-8080-8080-8080-808080808080', 'post', 'p0000015-0000-0000-0000-000000000015'),
('11111111-1111-1111-1111-111111111111', 'post', 'p0000015-0000-0000-0000-000000000015'),
('30303030-3030-3030-3030-303030303030', 'post', 'p0000015-0000-0000-0000-000000000015'),

-- More likes for various posts
('11111111-1111-1111-1111-111111111111', 'post', 'p0000017-0000-0000-0000-000000000017'),
('99999999-9999-9999-9999-999999999999', 'post', 'p0000017-0000-0000-0000-000000000017'),
('cccccccc-cccc-cccc-cccc-cccccccccccc', 'post', 'p0000017-0000-0000-0000-000000000017'),
('22222222-2222-2222-2222-222222222222', 'post', 'p0000017-0000-0000-0000-000000000017'),

('33333333-3333-3333-3333-333333333333', 'post', 'p0000018-0000-0000-0000-000000000018'),
('10101010-1010-1010-1010-101010101010', 'post', 'p0000018-0000-0000-0000-000000000018'),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'post', 'p0000018-0000-0000-0000-000000000018'),

('11111111-1111-1111-1111-111111111111', 'post', 'p0000020-0000-0000-0000-000000000020'),
('44444444-4444-4444-4444-444444444444', 'post', 'p0000020-0000-0000-0000-000000000020'),
('88888888-8888-8888-8888-888888888888', 'post', 'p0000020-0000-0000-0000-000000000020'),
('30303030-3030-3030-3030-303030303030', 'post', 'p0000020-0000-0000-0000-000000000020'),

('11111111-1111-1111-1111-111111111111', 'post', 'p0000031-0000-0000-0000-000000000031'),
('22222222-2222-2222-2222-222222222222', 'post', 'p0000031-0000-0000-0000-000000000031'),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'post', 'p0000031-0000-0000-0000-000000000031'),

('11111111-1111-1111-1111-111111111111', 'post', 'p0000032-0000-0000-0000-000000000032'),
('44444444-4444-4444-4444-444444444444', 'post', 'p0000032-0000-0000-0000-000000000032'),
('40404040-4040-4040-4040-404040404040', 'post', 'p0000032-0000-0000-0000-000000000032'),
('70707070-7070-7070-7070-707070707070', 'post', 'p0000032-0000-0000-0000-000000000032'),

('99999999-9999-9999-9999-999999999999', 'post', 'p0000034-0000-0000-0000-000000000034'),
('50505050-5050-5050-5050-505050505050', 'post', 'p0000034-0000-0000-0000-000000000034'),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'post', 'p0000034-0000-0000-0000-000000000034'),
('80808080-8080-8080-8080-808080808080', 'post', 'p0000034-0000-0000-0000-000000000034'),

('11111111-1111-1111-1111-111111111111', 'post', 'p0000035-0000-0000-0000-000000000035'),
('22222222-2222-2222-2222-222222222222', 'post', 'p0000035-0000-0000-0000-000000000035'),
('cccccccc-cccc-cccc-cccc-cccccccccccc', 'post', 'p0000035-0000-0000-0000-000000000035');
...
('c0000001-0000-0000-0000-000000000001', 'p0000001-0000-0000-0000-000000000001', '22222222-2222-2222-2222-222222222222', NULL, 'This sounds amazing! Already registered 🎉', NOW() - INTERVAL '1 day'),
('c0000002-0000-0000-0000-000000000002', 'p0000001-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'c0000001-0000-0000-0000-000000000001', 'Awesome! See you there 😊', NOW() - INTERVAL '23 hours'),
('c0000003-0000-0000-0000-000000000003', 'p0000001-0000-0000-0000-000000000001', '33333333-3333-3333-3333-333333333333', NULL, 'What time does it start exactly?', NOW() - INTERVAL '20 hours'),
('c0000004-0000-0000-0000-000000000004', 'p0000001-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'c0000003-0000-0000-0000-000000000003', '10 AM sharp! Don''t be late', NOW() - INTERVAL '19 hours'),

-- Comments on Post 2 (food tour)
('c0000005-0000-0000-0000-000000000005', 'p0000002-0000-0000-0000-000000000002', 'ffffffff-ffff-ffff-ffff-ffffffffffff', NULL, 'Count me in! Love street food 🍜', NOW() - INTERVAL '2 days'),
('c0000006-0000-0000-0000-000000000006', 'p0000002-0000-0000-0000-000000000002', '66666666-6666-6666-6666-666666666666', NULL, 'Which spots are we visiting?', NOW() - INTERVAL '2 days'),
('c0000007-0000-0000-0000-000000000007', 'p0000002-0000-0000-0000-000000000002', '22222222-2222-2222-2222-222222222222', 'c0000006-0000-0000-0000-000000000006', 'It''s a surprise! But trust me, all legendary spots', NOW() - INTERVAL '1 day'),

-- Comments on Post 3 (gaming tournament)
('c0000008-0000-0000-0000-000000000008', 'p0000003-0000-0000-0000-000000000003', '99999999-9999-9999-9999-999999999999', NULL, 'My team is ready! Let''s win this 🏆', NOW() - INTERVAL '3 days'),
('c0000009-0000-0000-0000-000000000009', 'p0000003-0000-0000-0000-000000000003', '10101010-1010-1010-1010-101010101010', NULL, 'Good luck everyone! May the best team win', NOW() - INTERVAL '3 days'),
('c0000010-0000-0000-0000-000000000010', 'p0000003-0000-0000-0000-000000000003', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'c0000008-0000-0000-0000-000000000008', 'We''re coming for that prize! 😎', NOW() - INTERVAL '2 days'),

-- Comments on Post 4 (watercolor art)
('c0000011-0000-0000-0000-000000000011', 'p0000004-0000-0000-0000-000000000004', '88888888-8888-8888-8888-888888888888', NULL, 'This is beautiful! 😍 You''re so talented', NOW() - INTERVAL '1 day'),
('c0000012-0000-0000-0000-000000000012', 'p0000004-0000-0000-0000-000000000004', '80808080-8080-8080-8080-808080808080', NULL, 'Love the color blending! What brand of paint do you use?', NOW() - INTERVAL '1 day'),
('c0000013-0000-0000-0000-000000000013', 'p0000004-0000-0000-0000-000000000004', '44444444-4444-4444-4444-444444444444', 'c0000012-0000-0000-0000-000000000012', 'Thank you! I use Winsor & Newton professional series', NOW() - INTERVAL '20 hours'),

-- Comments on Post 5 (running)
('c0000014-0000-0000-0000-000000000014', 'p0000005-0000-0000-0000-000000000005', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', NULL, 'Congrats! That''s an amazing time for your first 10K! 🎉', NOW() - INTERVAL '5 hours'),
('c0000015-0000-0000-0000-000000000015', 'p0000005-0000-0000-0000-000000000005', '20202020-2020-2020-2020-202020202020', NULL, 'Well done! Keep it up 💪', NOW() - INTERVAL '4 hours'),
('c0000016-0000-0000-0000-000000000016', 'p0000005-0000-0000-0000-000000000005', '11111111-1111-1111-1111-111111111111', NULL, 'Impressive! Join our run club next week!', NOW() - INTERVAL '3 hours'),

-- Comments on Post 8 (full-stack app)
('c0000017-0000-0000-0000-000000000017', 'p0000008-0000-0000-0000-000000000008', '50505050-5050-5050-5050-505050505050', NULL, 'Congrats on the deployment! 🚀 What does the app do?', NOW() - INTERVAL '2 days'),
('c0000018-0000-0000-0000-000000000018', 'p0000008-0000-0000-0000-000000000008', '99999999-9999-9999-9999-999999999999', 'c0000017-0000-0000-0000-000000000017', 'It''s a task management app with real-time collaboration!', NOW() - INTERVAL '1 day'),
('c0000019-0000-0000-0000-000000000019', 'p0000008-0000-0000-0000-000000000008', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', NULL, 'That''s awesome! Is it open source?', NOW() - INTERVAL '1 day'),
('c0000020-0000-0000-0000-000000000020', 'p0000008-0000-0000-0000-000000000008', '99999999-9999-9999-9999-999999999999', 'c0000019-0000-0000-0000-000000000019', 'Not yet, but planning to open source it soon!', NOW() - INTERVAL '20 hours'),

-- Comments on Post 11 (photography)
('c0000021-0000-0000-0000-000000000021', 'p0000011-0000-0000-0000-000000000011', '44444444-4444-4444-4444-444444444444', NULL, 'These shots are incredible! 📸✨', NOW() - INTERVAL '1 day'),
('c0000022-0000-0000-0000-000000000022', 'p0000011-0000-0000-0000-000000000011', '70707070-7070-7070-7070-707070707070', NULL, 'What camera settings did you use?', NOW() - INTERVAL '22 hours'),
('c0000023-0000-0000-0000-000000000023', 'p0000011-0000-0000-0000-000000000011', '88888888-8888-8888-8888-888888888888', 'c0000022-0000-0000-0000-000000000022', 'f/2.8, ISO 200, 1/250s. Shot on Canon R5', NOW() - INTERVAL '20 hours'),
('c0000024-0000-0000-0000-000000000024', 'p0000011-0000-0000-0000-000000000011', '40404040-4040-4040-4040-404040404040', NULL, 'The composition is perfect! Love the third shot especially', NOW() - INTERVAL '18 hours'),

-- Comments on Post 17 (startup funding)
('c0000025-0000-0000-0000-000000000025', 'p0000017-0000-0000-0000-000000000017', '11111111-1111-1111-1111-111111111111', NULL, 'Huge congratulations! 🎉 This is inspiring!', NOW() - INTERVAL '3 days'),
('c0000026-0000-0000-0000-000000000026', 'p0000017-0000-0000-0000-000000000017', '99999999-9999-9999-9999-999999999999', NULL, 'That''s amazing! What''s your startup about?', NOW() - INTERVAL '2 days'),
('c0000027-0000-0000-0000-000000000027', 'p0000017-0000-0000-0000-000000000017', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'c0000026-0000-0000-0000-000000000026', 'We''re building AI-powered supply chain optimization', NOW() - INTERVAL '2 days'),
('c0000028-0000-0000-0000-000000000028', 'p0000017-0000-0000-0000-000000000017', 'cccccccc-cccc-cccc-cccc-cccccccccccc', NULL, 'So proud of you! Let''s celebrate soon 🍾', NOW() - INTERVAL '2 days'),

-- Comments on Post 34 (debugging joke)
('c0000029-0000-0000-0000-000000000029', 'p0000034-0000-0000-0000-000000000034', '50505050-5050-5050-5050-505050505050', NULL, 'LMAO this is so accurate 😂', NOW() - INTERVAL '17 hours'),
('c0000030-0000-0000-0000-000000000030', 'p0000034-0000-0000-0000-000000000034', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', NULL, 'Every. Single. Time. 😅', NOW() - INTERVAL '16 hours'),
('c0000031-0000-0000-0000-000000000031', 'p0000034-0000-0000-0000-000000000034', '80808080-8080-8080-8080-808080808080', NULL, 'The semicolon is always guilty 😂', NOW() - INTERVAL '15 hours'),
('c0000032-0000-0000-0000-000000000032', 'p0000034-0000-0000-0000-000000000034', '99999999-9999-9999-9999-999999999999', 'c0000030-0000-0000-0000-000000000030', 'Story of my life as a developer', NOW() - INTERVAL '14 hours'),

-- More comments on popular posts
('c0000033-0000-0000-0000-000000000033', 'p0000031-0000-0000-0000-000000000031', '22222222-2222-2222-2222-222222222222', NULL, 'That rosetta is perfect! 😍☕', NOW() - INTERVAL '12 hours'),
('c0000034-0000-0000-0000-000000000034', 'p0000031-0000-0000-0000-000000000031', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', NULL, 'Teach me your ways! Mine always turns out like a blob 😅', NOW() - INTERVAL '11 hours'),
('c0000035-0000-0000-0000-000000000035', 'p0000031-0000-0000-0000-000000000031', '11111111-1111-1111-1111-111111111111', 'c0000034-0000-0000-0000-000000000034', 'Come to my latte art workshop next week! 😊', NOW() - INTERVAL '10 hours'),

('c0000036-0000-0000-0000-000000000036', 'p0000006-0000-0000-0000-000000000006', '44444444-4444-4444-4444-444444444444', NULL, 'Added to my reading list! Thanks for the recommendation 📚', NOW() - INTERVAL '10 hours'),
('c0000037-0000-0000-0000-000000000037', 'p0000006-0000-0000-0000-000000000006', '50505050-5050-5050-5050-505050505050', NULL, 'One of my favorite books! The story is incredible', NOW() - INTERVAL '8 hours'),

('c0000038-0000-0000-0000-000000000038', 'p0000035-0000-0000-0000-000000000035', '11111111-1111-1111-1111-111111111111', NULL, 'Great tip! Temperature control is so underrated', NOW() - INTERVAL '20 hours'),
('c0000039-0000-0000-0000-000000000039', 'p0000035-0000-0000-0000-000000000035', '22222222-2222-2222-2222-222222222222', NULL, 'I learned this the hard way 😅 Now my coffee tastes so much better', NOW() - INTERVAL '18 hours'),

('c0000040-0000-0000-0000-000000000040', 'p0000040-0000-0000-0000-000000000040', '10101010-1010-1010-1010-101010101010', NULL, 'My top 3: 1. Attack on Titan 2. Demon Slayer 3. One Piece', NOW() - INTERVAL '11 hours'),
('c0000041-0000-0000-0000-000000000041', 'p0000040-0000-0000-0000-000000000040', '33333333-3333-3333-3333-333333333333', NULL, 'One Piece, JJK, and Vinland Saga!', NOW() - INTERVAL '10 hours'),
('c0000042-0000-0000-0000-000000000042', 'p0000040-0000-0000-0000-000000000040', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', NULL, 'You need to watch Steins;Gate! Mind-blowing 🤯', NOW() - INTERVAL '9 hours');
