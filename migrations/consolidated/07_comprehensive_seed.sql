...
INSERT INTO users (id, email, password_hash, name, username, bio, avatar_url, phone, date_of_birth, gender, location, interests, is_verified, is_email_verified) VALUES
-- Main active users
('11111111-1111-1111-1111-111111111111', 'rudi@anigmaa.com', '$2a$10$xyz...', 'Rudi Hartono', 'rudihartono', 'Coffee enthusiast | Event organizer | Jakarta', 'https://i.pravatar.cc/150?img=1', '08123456701', '1990-03-15', 'Laki-laki', 'Jakarta', ARRAY['Coffee', 'Events'], true, true),
('22222222-2222-2222-2222-222222222222', 'siti@anigmaa.com', '$2a$10$xyz...', 'Siti Nurhaliza', 'sitinur', 'Foodie & travel lover 🌏', 'https://i.pravatar.cc/150?img=2', '08123456702', '1992-07-20', 'Perempuan', 'Bandung', ARRAY['Food', 'Travel'], true, true),
('33333333-3333-3333-3333-333333333333', 'budi@anigmaa.com', '$2a$10$xyz...', 'Budi Santoso', 'budisantoso', 'Gamer | Esports enthusiast', 'https://i.pravatar.cc/150?img=3', '08123456703', '1998-01-10', 'Laki-laki', 'Jakarta', ARRAY['Gaming', 'Esports'], true, true),
('44444444-4444-4444-4444-444444444444', 'maya@anigmaa.com', '$2a$10$xyz...', 'Maya Wijaya', 'mayawijaya', 'Artist & designer 🎨', 'https://i.pravatar.cc/150?img=4', '08123456704', '1995-05-25', 'Perempuan', 'Yogyakarta', ARRAY['Art', 'Design'], true, true),
('55555555-5555-5555-5555-555555555555', 'andi@anigmaa.com', '$2a$10$xyz...', 'Andi Pratama', 'andipratama', 'Fitness & sports | Marathon runner', 'https://i.pravatar.cc/150?img=5', '08123456705', '1988-11-30', 'Laki-laki', 'Surabaya', ARRAY['Sports', 'Fitness'], true, true),
('66666666-6666-6666-6666-666666666666', 'dewi@anigmaa.com', '$2a$10$xyz...', 'Dewi Lestari', 'dewilestari', 'Writer | Book lover 📚', 'https://i.pravatar.cc/150?img=6', '08123456706', '1993-02-14', 'Perempuan', 'Jakarta', ARRAY['Books', 'Writing'], true, true),
('77777777-7777-7777-7777-777777777777', 'agus@anigmaa.com', '$2a$10$xyz...', 'Agus Setiawan', 'agussetiawan', 'Music producer | DJ', 'https://i.pravatar.cc/150?img=7', '08123456707', '1991-08-08', 'Laki-laki', 'Bali', ARRAY['Music', 'DJ'], true, true),
('88888888-8888-8888-8888-888888888888', 'rina@anigmaa.com', '$2a$10$xyz...', 'Rina Kusuma', 'rinakusuma', 'Photographer | Content creator', 'https://i.pravatar.cc/150?img=8', '08123456708', '1996-04-18', 'Perempuan', 'Jakarta', ARRAY['Photography', 'Content'], true, true),
('99999999-9999-9999-9999-999999999999', 'doni@anigmaa.com', '$2a$10$xyz...', 'Doni Rahman', 'donirahman', 'Tech enthusiast | Developer', 'https://i.pravatar.cc/150?img=9', '08123456709', '1994-12-05', 'Laki-laki', 'Jakarta', ARRAY['Technology', 'Programming'], true, true),
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'linda@anigmaa.com', '$2a$10$xyz...', 'Linda Permata', 'lindapermata', 'Yoga instructor | Wellness coach', 'https://i.pravatar.cc/150?img=10', '08123456710', '1989-06-22', 'Perempuan', 'Ubud', ARRAY['Yoga', 'Wellness'], true, true),
-- Additional users
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'rizki@anigmaa.com', '$2a$10$xyz...', 'Rizki Maulana', 'rizkimaulana', 'Student | Coffee addict', 'https://i.pravatar.cc/150?img=11', '08123456711', '2001-09-12', 'Laki-laki', 'Jakarta', ARRAY['Coffee', 'Study'], true, true),
('cccccccc-cccc-cccc-cccc-cccccccccccc', 'sarah@anigmaa.com', '$2a$10$xyz...', 'Sarah Amelia', 'sarahamelia', 'Marketing | Social media enthusiast', 'https://i.pravatar.cc/150?img=12', '08123456712', '1997-03-28', 'Perempuan', 'Jakarta', ARRAY['Marketing', 'Social Media'], true, true),
('dddddddd-dddd-dddd-dddd-dddddddddddd', 'tommy@anigmaa.com', '$2a$10$xyz...', 'Tommy Wijaya', 'tommywijaya', 'Entrepreneur | Startup founder', 'https://i.pravatar.cc/150?img=13', '08123456713', '1990-10-15', 'Laki-laki', 'Jakarta', ARRAY['Startup', 'Business'], true, true),
('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'novi@anigmaa.com', '$2a$10$xyz...', 'Novi Indah', 'noviindah', 'Fashion blogger | Style icon', 'https://i.pravatar.cc/150?img=14', '08123456714', '1999-01-07', 'Perempuan', 'Jakarta', ARRAY['Fashion', 'Style'], true, true),
('ffffffff-ffff-ffff-ffff-ffffffffffff', 'hadi@anigmaa.com', '$2a$10$xyz...', 'Hadi Kurniawan', 'hadikurniawan', 'Chef | Culinary expert', 'https://i.pravatar.cc/150?img=15', '08123456715', '1987-05-19', 'Laki-laki', 'Bali', ARRAY['Cooking', 'Food'], true, true),
('10101010-1010-1010-1010-101010101010', 'tina@anigmaa.com', '$2a$10$xyz...', 'Tina Sari', 'tinasari', 'Student | Anime lover', 'https://i.pravatar.cc/150?img=16', '08123456716', '2002-11-03', 'Perempuan', 'Jakarta', ARRAY['Anime', 'Gaming'], true, true),
('20202020-2020-2020-2020-202020202020', 'ferry@anigmaa.com', '$2a$10$xyz...', 'Ferry Gunawan', 'ferrygunawan', 'Cyclist | Outdoor enthusiast', 'https://i.pravatar.cc/150?img=17', '08123456717', '1994-08-26', 'Laki-laki', 'Bandung', ARRAY['Cycling', 'Outdoor'], true, true),
('30303030-3030-3030-3030-303030303030', 'indah@anigmaa.com', '$2a$10$xyz...', 'Indah Sari', 'indahsari', 'Dancer | Choreographer', 'https://i.pravatar.cc/150?img=18', '08123456718', '1996-02-09', 'Perempuan', 'Jakarta', ARRAY['Dance', 'Arts'], true, true),
('40404040-4040-4040-4040-404040404040', 'bambang@anigmaa.com', '$2a$10$xyz...', 'Bambang Sutopo', 'bambangsutopo', 'Film maker | Cinematographer', 'https://i.pravatar.cc/150?img=19', '08123456719', '1985-12-21', 'Laki-laki', 'Jakarta', ARRAY['Film', 'Photography'], true, true),
('50505050-5050-5050-5050-505050505050', 'yuni@anigmaa.com', '$2a$10$xyz...', 'Yuni Astuti', 'yuniastuti', 'Teacher | Education advocate', 'https://i.pravatar.cc/150?img=20', '08123456720', '1991-04-16', 'Perempuan', 'Surabaya', ARRAY['Education', 'Teaching'], true, true),
('60606060-6060-6060-6060-606060606060', 'eko@anigmaa.com', '$2a$10$xyz...', 'Eko Prasetyo', 'ekoprasetyo', 'Basketball player | Sports coach', 'https://i.pravatar.cc/150?img=21', '08123456721', '1993-07-11', 'Laki-laki', 'Jakarta', ARRAY['Basketball', 'Sports'], true, true),
('70707070-7070-7070-7070-707070707070', 'putri@anigmaa.com', '$2a$10$xyz...', 'Putri Maharani', 'putrimaharani', 'Vlogger | Content creator', 'https://i.pravatar.cc/150?img=22', '08123456722', '1998-10-30', 'Perempuan', 'Jakarta', ARRAY['Vlogging', 'Content'], true, true),
('80808080-8080-8080-8080-808080808080', 'irfan@anigmaa.com', '$2a$10$xyz...', 'Irfan Hakim', 'irfanhakim', 'Graphic designer | Illustrator', 'https://i.pravatar.cc/150?img=23', '08123456723', '1992-01-24', 'Laki-laki', 'Yogyakarta', ARRAY['Design', 'Illustration'], true, true),
('90909090-9090-9090-9090-909090909090', 'lina@anigmaa.com', '$2a$10$xyz...', 'Lina Marlina', 'linamarlina', 'Nutritionist | Healthy lifestyle', 'https://i.pravatar.cc/150?img=24', '08123456724', '1990-09-08', 'Perempuan', 'Jakarta', ARRAY['Health', 'Nutrition'], true, true),
('a0a0a0a0-a0a0-a0a0-a0a0-a0a0a0a0a0a0', 'dimas@anigmaa.com', '$2a$10$xyz...', 'Dimas Ardiansyah', 'dimasardiansyah', 'Musician | Guitarist', 'https://i.pravatar.cc/150?img=25', '08123456725', '1995-06-17', 'Laki-laki', 'Bali', ARRAY['Music', 'Guitar'], true, true);
...
('a0000004-0000-0000-0000-000000000004', '44444444-4444-4444-4444-444444444444', 'Just finished a new watercolor painting! The sunset colors turned out better than expected 🎨✨ Sometimes the best art happens when you just let go and trust the process.', 'text_with_event', 'e0000044-0000-0000-0000-000000000044', 'public', NOW() - INTERVAL '1 day'),
('a0000005-0000-0000-0000-000000000005', '55555555-5555-5555-5555-555555555555', 'Completed my first 10K run today! 🏃‍♂️💪 Time: 58:32. Not bad for a beginner. The key is consistency, not speed. Keep moving forward!', 'text_with_event', 'e0000037-0000-0000-0000-000000000037', 'public', NOW() - INTERVAL '5 hours'),
('a0000006-0000-0000-0000-000000000006', '66666666-6666-6666-6666-666666666666', 'Currently reading "Educated" by Tara Westover and wow... speechless. Her journey is incredibly inspiring. Anyone else read this? Let''s discuss! 📚', 'text_with_event', 'e0000022-0000-0000-0000-000000000022', 'public', NOW() - INTERVAL '12 hours'),
('a0000007-0000-0000-0000-000000000007', '77777777-7777-7777-7777-777777777777', 'Working on a new track 🎵 Been in the studio for 6 hours straight and I think we''re onto something special. Can''t wait to share it with you all!', 'text_with_event', 'e0000039-0000-0000-0000-000000000039', 'public', NOW() - INTERVAL '8 hours'),
('a0000008-0000-0000-0000-000000000008', '99999999-9999-9999-9999-999999999999', 'Finally deployed my first full-stack app! 🚀 React + Node.js + PostgreSQL. So many bugs fixed, so many lessons learned. The feeling is unreal!', 'text_with_event', 'e0000043-0000-0000-0000-000000000043', 'public', NOW() - INTERVAL '2 days'),
('a0000009-0000-0000-0000-000000000009', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Morning yoga session hits different when you do it at the park 🧘‍♀️ The fresh air and bird sounds are the best meditation soundtrack. Namaste 🙏', 'text_with_event', 'e0000037-0000-0000-0000-000000000037', 'public', NOW() - INTERVAL '15 hours'),
('a0000010-0000-0000-0000-000000000010', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Trying a new coffee brewing method today: Japanese iced coffee ☕❄️ The flavor is SO much better than regular cold brew. Mind = blown!', 'text_with_event', 'e0000032-0000-0000-0000-000000000032', 'public', NOW() - INTERVAL '6 hours'),

-- Posts with images (all with events)
('a0000011-0000-0000-0000-000000000011', '88888888-8888-8888-8888-888888888888', 'Golden hour at Kota Tua was absolutely magical today 📸✨ Managed to capture some incredible shots. Swipe to see the full series!', 'text_with_images', 'e0000050-0000-0000-0000-000000000050', 'public', NOW() - INTERVAL '1 day'),
('a0000012-0000-0000-0000-000000000012', '22222222-2222-2222-2222-222222222222', 'Made homemade pasta from scratch! 🍝 It was challenging but so worth it. The taste is incomparable to store-bought pasta. Here''s the process!', 'text_with_images', 'e0000005-0000-0000-0000-000000000005', 'public', NOW() - INTERVAL '18 hours'),
('a0000013-0000-0000-0000-000000000013', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'Today''s outfit inspo ✨ Mixing vintage with contemporary pieces. Fashion is all about expressing yourself! What do you think?', 'text_with_images', 'e0000029-0000-0000-0000-000000000029', 'public', NOW() - INTERVAL '10 hours'),
('a0000014-0000-0000-0000-000000000014', 'ffffffff-ffff-ffff-ffff-ffffffffffff', 'Behind the scenes of today''s cooking class 👨‍🍳 These students are amazing! We made authentic Italian risotto. Check out their creations!', 'text_with_images', 'e0000034-0000-0000-0000-000000000034', 'public', NOW() - INTERVAL '7 hours'),
('a0000015-0000-0000-0000-000000000015', '44444444-4444-4444-4444-444444444444', 'My latest illustration project 🎨 Inspired by Indonesian folklore. Took me 12 hours to complete. Art is patience!', 'text_with_images', 'e0000045-0000-0000-0000-000000000045', 'public', NOW() - INTERVAL '2 days'),
...
('a0000017-0000-0000-0000-000000000017', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'Startup life update: Just closed our seed round! 🎉💰 The journey from idea to funding was intense. Grateful for everyone who believed in our vision. This is just the beginning!', 'text_with_event', 'e0000046-0000-0000-0000-000000000046', 'public', NOW() - INTERVAL '3 days'),
('a0000018-0000-0000-0000-000000000018', '10101010-1010-1010-1010-101010101010', 'Watching anime at 3AM hits different lol 😂 Just finished Attack on Titan final season and I have SO MANY FEELINGS. No spoilers please for those who haven''t watched!', 'text_with_event', 'e0000041-0000-0000-0000-000000000041', 'public', NOW() - INTERVAL '4 hours'),
('a0000019-0000-0000-0000-000000000019', '20202020-2020-2020-2020-202020202020', 'Best cycling routes in Jakarta? Drop your recommendations! 🚴‍♂️ Planning to explore new areas this weekend. Preferably with good coffee shops along the way ☕', 'text_with_event', 'e0000014-0000-0000-0000-000000000014', 'public', NOW() - INTERVAL '16 hours'),
('a0000020-0000-0000-0000-000000000020', '30303030-3030-3030-3030-303030303030', 'Dance practice was INTENSE today 💃 We''re preparing for a big performance next month. My legs are sore but my heart is happy. This is what passion feels like!', 'text_with_event', 'e0000024-0000-0000-0000-000000000024', 'public', NOW() - INTERVAL '11 hours'),
...
('a0000024-0000-0000-0000-000000000024', '40404040-4040-4040-4040-404040404040', 'Just wrapped filming for a new documentary about Jakarta''s hidden gems 🎬 The stories we captured are incredible. Can''t wait to share it with everyone!', 'text_with_event', 'e0000041-0000-0000-0000-000000000041', 'public', NOW() - INTERVAL '1 day'),
('a0000025-0000-0000-0000-000000000025', '50505050-5050-5050-5050-505050505050', 'Teaching high school students about climate change today. Their questions were so thoughtful and inspiring 🌍 The next generation gives me hope!', 'text_with_event', 'e0000042-0000-0000-0000-000000000042', 'public', NOW() - INTERVAL '9 hours'),
('a0000026-0000-0000-0000-000000000026', '60606060-6060-6060-6060-606060606060', 'Basketball training session was fire today! 🏀🔥 Working on my three-point shot. Practice makes progress, not perfection.', 'text_with_event', 'e0000013-0000-0000-0000-000000000013', 'public', NOW() - INTERVAL '14 hours'),
('a0000027-0000-0000-0000-000000000027', '70707070-7070-7070-7070-707070707070', 'Just posted a new vlog about Jakarta''s best coffee spots! ☕📹 Link in bio. Let me know which cafe I should review next!', 'text_with_event', 'e0000031-0000-0000-0000-000000000031', 'public', NOW() - INTERVAL '22 hours'),
('a0000028-0000-0000-0000-000000000028', '80808080-8080-8080-8080-808080808080', 'Working on a new logo design for a client 🎨💻 The creative process is messy but magical. Here''s to late nights and coffee-fueled inspiration!', 'text_with_event', 'e0000025-0000-0000-0000-000000000025', 'public', NOW() - INTERVAL '3 hours'),
('a0000029-0000-0000-0000-000000000029', '90909090-9090-9090-9090-909090909090', 'Meal prep Sunday! 🥗 Prepared healthy lunches for the whole week. Nutrition is self-care. Your body will thank you!', 'text_with_event', 'e0000006-0000-0000-0000-000000000006', 'public', NOW() - INTERVAL '1 day'),
('a0000030-0000-0000-0000-000000000030', 'a0a0a0a0-a0a0-a0a0-a0a0-a0a0a0a0a0a0', 'New song coming this Friday! 🎵🎸 Been working on this for months. The wait is almost over. Pre-save link coming soon!', 'text_with_event', 'e0000040-0000-0000-0000-000000000040', 'public', NOW() - INTERVAL '2 days'),

-- More posts with images (all with events)
('a0000031-0000-0000-0000-000000000031', '11111111-1111-1111-1111-111111111111', 'Coffee art game strong today ☕✨ Managed to pour a perfect rosetta! Practice really does make better. Here''s the progression shots!', 'text_with_images', 'e0000002-0000-0000-0000-000000000002', 'public', NOW() - INTERVAL '13 hours'),
('a0000032-0000-0000-0000-000000000032', '88888888-8888-8888-8888-888888888888', 'Sunset photography from rooftop Jakarta 🌅 The city looks beautiful from up here. Sometimes we need to change our perspective to see beauty.', 'text_with_images', 'e0000050-0000-0000-0000-000000000050', 'public', NOW() - INTERVAL '19 hours'),
('a0000033-0000-0000-0000-000000000033', '33333333-3333-3333-3333-333333333333', 'New gaming setup complete! 🎮⚡ RGB everything lol. Ready for that tournament next week. Let''s goooo!', 'text_with_images', 'e0000035-0000-0000-0000-000000000035', 'public', NOW() - INTERVAL '2 days'),

-- More text posts (all with events)
('a0000034-0000-0000-0000-000000000034', '99999999-9999-9999-9999-999999999999', 'Debugging is like being a detective in a crime movie where you are also the murderer 😅 Finally found that bug after 3 hours. The culprit? A missing semicolon. Classic.', 'text_with_event', 'e0000021-0000-0000-0000-000000000021', 'public', NOW() - INTERVAL '17 hours'),
('a0000035-0000-0000-0000-000000000035', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Coffee tip of the day: Water temperature matters! 92-96°C is the sweet spot for most brewing methods ☕🌡️ Too hot = bitter, too cold = sour. Science!', 'text_with_event', 'e0000003-0000-0000-0000-000000000003', 'public', NOW() - INTERVAL '21 hours'),
('a0000036-0000-0000-0000-000000000036', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'Social media algorithm changes again 📱 Time to adapt our strategy. The key is always authentic content and community engagement. Algorithms come and go, but real connections last.', 'text_with_event', 'e0000027-0000-0000-0000-000000000027', 'public', NOW() - INTERVAL '1 day'),
('a0000037-0000-0000-0000-000000000037', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'Pitch deck tip: Tell a story, not just facts 📊 Investors invest in people and vision, not just numbers. Make them feel your passion!', 'text_with_event', 'e0000026-0000-0000-0000-000000000026', 'public', NOW() - INTERVAL '4 days'),
('a0000038-0000-0000-0000-000000000038', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'Thrifting finds of the week! 🛍️ Found some vintage pieces that are absolute gems. Sustainable fashion is the future!', 'text_with_event', 'e0000029-0000-0000-0000-000000000029', 'public', NOW() - INTERVAL '23 hours'),
('a0000039-0000-0000-0000-000000000039', 'ffffffff-ffff-ffff-ffff-ffffffffffff', 'Cooking is like chemistry but you can eat the results 👨‍🍳🧪 Today''s experiment: fusion Indonesian-Italian cuisine. Rendang risotto anyone?', 'text_with_event', 'e0000033-0000-0000-0000-000000000033', 'public', NOW() - INTERVAL '15 hours'),
('a0000040-0000-0000-0000-000000000040', '10101010-1010-1010-1010-101010101010', 'Anime recommendation thread! Drop your top 3 anime below 👇 Always looking for new shows to watch. My current faves: AOT, Demon Slayer, JJK.', 'text_with_event', 'e0000041-0000-0000-0000-000000000041', 'public', NOW() - INTERVAL '12 hours'),
...
('a0000044-0000-0000-0000-000000000044', '11111111-1111-1111-1111-111111111111', 'Random thought: The best conversations happen over coffee ☕💬 There''s something about caffeine that makes us more creative and connected.', 'text_with_event', 'e0000001-0000-0000-0000-000000000001', 'public', NOW() - INTERVAL '8 hours'),
('a0000045-0000-0000-0000-000000000045', '22222222-2222-2222-2222-222222222222', 'Food coma after that amazing nasi goreng 😴🍛 Sometimes the best comfort is in our traditional food. Nothing beats Indonesian cuisine!', 'text_with_event', 'e0000007-0000-0000-0000-000000000007', 'public', NOW() - INTERVAL '5 hours'),
('a0000046-0000-0000-0000-000000000046', '33333333-3333-3333-3333-333333333333', 'Pro tip for gamers: Take breaks! 🎮⏸️ Your performance actually improves when you rest your eyes and stretch. Health > Rank.', 'text_with_event', 'e0000036-0000-0000-0000-000000000036', 'public', NOW() - INTERVAL '11 hours'),
('a0000047-0000-0000-0000-000000000047', '55555555-5555-5555-5555-555555555555', 'Marathon training week 8 done! 🏃‍♂️✅ The journey from couch to marathon is real. Every step counts. Keep going!', 'text_with_event', 'e0000011-0000-0000-0000-000000000011', 'public', NOW() - INTERVAL '7 hours'),
('a0000048-0000-0000-0000-000000000048', '77777777-7777-7777-7777-777777777777', 'Music is the universal language 🎵🌍 Doesn''t matter where you''re from, good music connects us all. What song are you listening to right now?', 'text_with_event', 'e0000017-0000-0000-0000-000000000017', 'public', NOW() - INTERVAL '9 hours'),
('a0000049-0000-0000-0000-000000000049', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Yoga isn''t about touching your toes, it''s about what you learn on the way down 🧘‍♀️✨ Flexibility of mind > flexibility of body.', 'text_with_event', 'e0000028-0000-0000-0000-000000000028', 'public', NOW() - INTERVAL '6 hours'),
('a0000050-0000-0000-0000-000000000050', '99999999-9999-9999-9999-999999999999', 'Just remembered why I love coding: The moment when your code finally works after hours of debugging 🎉💻 That dopamine hit is unmatched!', 'text_with_event', 'e0000043-0000-0000-0000-000000000043', 'public', NOW() - INTERVAL '4 hours');
